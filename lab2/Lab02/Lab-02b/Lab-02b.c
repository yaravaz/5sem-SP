...
int main() {
    ...
    if (!CreateProcess(fileName, NULL, NULL, NULL, FALSE, 0, NULL, NULL, &startupInfo[0], &processInfo[0])) {
    ...
    SetEnvironmentVariable(L"ITER_NUM", L"10");
    if (!CreateProcess(fileName, NULL, NULL, NULL, FALSE, 0, NULL, NULL, &startupInfo[2], &processInfo[2])) {
        DWORD error = GetLastError();
